...
This file governs how Codex works in `solana-vault-prototype`. Read it before any change.
...
- Never add `Co-authored-by: Codex`, `Generated-by: Codex`, `Signed-off-by: Codex`,
